...
app.get('/patched.apk', (_, res) => {
  const file = join(process.cwd(), 'patched', global.outputName);
...
process.on('uncaughtException', (reason) => {
  ...
  log(
    'Please report this bug here: https://github.com/FAUZAN-CELL/fz-builder/issues.'
  );
});
